 ...
 <form  action="tujingzhongzhuandian_add.jsp?f=f&id=<%=id%>"  method="post" name="form1"  onsubmit="return checkform();">
  ...
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#cccccc" >
		<tr><td  width="200">途径中转点名称：</td><td><input name='tujingzhongzhuandianmingcheng' type='text' id='tujingzhongzhuandianmingcheng' value='' onblur='checkform()' class="form-control" />&nbsp;*<label id='clabeltujingzhongzhuandianmingcheng' /></td></tr>		
    <tr>
      <td>&nbsp;</td>
...
if(msg.indexOf('Y')>-1){
document.getElementById("clabeltujingzhongzhuandianmingcheng").innerHTML="&nbsp;&nbsp;<font color=red>途径中转点名称已存在</font>";  
return false;

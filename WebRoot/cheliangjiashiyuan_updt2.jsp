...
HashMap mmm = new CommDAO().getmaps("jiashiyuanzhanghao",(String)request.getSession().getAttribute("username"),"cheliangjiashiyuan"); 
%>
  <form  action="cheliangjiashiyuan_updt2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改车辆驾驶员:
  <br><br>
  <%

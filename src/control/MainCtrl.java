	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				if(utype.equals("车辆驾驶员")){sql1 = "select * from cheliangjiashiyuan where jiashiyuanzhanghao='"+username+"' and mima='"+password+"' ";}if(utype.equals("普通用户")){sql1 = "select * from putongyonghu where yonghuming='"+username+"' and mima='"+password+"' ";}
